            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="<?php echo e(url('/')); ?>" class="active">Home</a></li>
...
<tr style="position:relative; top:-60px; right:-360px;"><td><a href="<?php echo e(url('/remove',$data2->id)); ?>" class="btn btn-info">Remove</a></td></tr>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>

<div align="center" style="padding:10px; ">
<button type="button" class="btn btn-outline-secondary" type="button" id="order"> Order Now</button>
...
<div style="padding:10px;">
        ...
        <button id="close" type="button" class="btn btn-outline-dark">Close</button>
</div>
</div>
</form>
...
</html><?php /**PATH E:\totorial\restaurant\resources\views/showcart.blade.php ENDPATH**/ ?>